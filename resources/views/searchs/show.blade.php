                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="p-2">
                                        <form method="POST" action="{{route('search.update',$search->id)}}" class="form-horizontal" role="form" id="storeForm">
                                            @csrf
                                            <input type="hidden" name="_method" value="PUT">
                                            <div class="mb-2 row">
                                                <label class="col-md-2 col-form-label" for="keyword">キーワード</label>
                                                <div class="col-md-10">
                                                    <input type="text" name="keyword" id="keyword" class="form-control" value="{{$search->keyword}}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-2 row">
                                                ...
                                                <div class="col-md-10">
                                                    <input class="form-control" type="number" id="lower_price" value="{{$search->lower_price}}" name="lower_price">
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-2 row">
                                                ...
                                                <div class="col-md-10">
                                                    <input class="form-control" type="number" id="upper_price" value="{{$search->upper_price}}" name="upper_price">
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-2 row">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" id="excluded_word" value="{{$search->excluded_words}}" name="excluded_word" class="form-control" placeholder="スペースで区切ります。">
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-2 row">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" id="item_status" value="{{$search->status}}" name="status" class="form-control" value="">
                                                </div>
                                            </div>
